      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p className="mt-4 font-semibold text-gray-900">**Formula:**</p>
          ...
          <section>
            ...
            <p className="mt-4 font-semibold text-gray-900">**Example:**</p>
            <pre className="bg-gray-100 p-4 rounded-md text-gray-800">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p>Simply input your subject codes, names, credits, and grades. The calculator will instantly compute your SGPA using VTU's official formula.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
